...
export default function SetTimer({closeModal}) {
    ...
    const { autoStartPomodoro: autoPom, autoStartBreaks: autoBreak, longBreakInterval,  pomodoroTime, shortBreakTime, longBreakTime } = useSelector(state => state.timer.times)
    ...
    function submitHandler(e) {
      e.preventDefault();
      dispatch(setTimes({ pomodoroTime:pomTime, 
        shortBreakTime: shortTime, 
        longBreakTime: longTime, autoStartPomodoro, autoStartBreaks, longInterval }));
        closeModal()
    }
